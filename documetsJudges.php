...
?>
 ...
 <main class="documents-main">
        <div class="breadcrumbs">
            <div class="container">
                <a class="a-title" href="/"><span>Главная</span></a> <span>| </span>
                <a class="a-title" href="/dokumenty/"><span>Документы</span> </a>
                <span>| Судейский и дисциплинарный комитет</span>
            </div>
        </div>
          <div class="container">
            <div class="red-title">
        ...
        <div class="documents">
            <div class="document-block">
                ...
                <div class="document">
                    <div class="document-title">
                    <img class="galochka" src="<?php echo bloginfo('template_url');?>/assets/img/list.svg" alt="">
                    <p class="doc-name"><?php the_field('txt5');?></p>
                    </div>
                    <div class="document-spoiler">
                        <div class="doc-download">
            ...
            <div class="document-menu">
                <a href="/dokumenty/">                    
                    ...
                    <img class="img-svg"  src="<?php echo bloginfo('template_url');?>/assets/img/logo-mini.svg" alt="">
                    <p class="white">Документы</p>
                    </div></a>
                    <div class="document-menu-1">
                    <img src="<?php echo bloginfo('template_url');?>/assets/img/logo-mini.svg" alt="">
                    <p class="white doc-judes-txt">Судейский и дисциплинарный комитет</p>
                    </div>
                </div>
        </div>
