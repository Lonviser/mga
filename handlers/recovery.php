...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ){
  ...
  if ($stmt = mysqli_prepare($db, $query)) {
    ...
    $msg = "Если эта не Ваша попытка восстановить пароль, проигнорируйте это сообщение. Если Вы пытаетесь восстановить пароль, нажмите на <a href=\"http://{$_SERVER['SERVER_NAME']}/reg22?recovery_token=" . $recovery_token . "\">ссылку</a> для установки нового пароля";  
    $headers = "From: no-reply@{$_SERVER['SERVER_NAME']}";
  	mail("$email", "Восстановление пароля mgafamily.by", "$msg");  
